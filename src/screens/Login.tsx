      ...
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} bounces={false}>
          ...
          <View style={[styles.formContainer, { backgroundColor: colors.background }]}>
            ...
            <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Login to your account to continue.</Text>
            ...
            <TouchableOpacity style={[styles.loginButton, { backgroundColor: colors.primary, shadowColor: colors.primary }]} onPress={signIn}>
              <Text style={styles.loginButtonText}>Login</Text>
            </TouchableOpacity>

            <View style={styles.dividerContainer}>
              <View style={[styles.dividerLine, { backgroundColor: colors.border }]} />
              <Text style={[styles.dividerText, { color: colors.textSecondary }]}>or continue</Text>
              <View style={[styles.dividerLine, { backgroundColor: colors.border }]} />
            </View>
